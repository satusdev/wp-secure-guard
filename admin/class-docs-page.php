...
final class Secure_Guard_Docs_Page {
    ...
    public function render(): void {
        ...
        <div class="wrap secure-guard-ui">
            <h1><?php esc_html_e('Documentation & Usage', 'wp-secure-guard'); ?></h1>

            <div class="sg-docs-layout">
                <aside class="sg-docs-sidebar">
                    <nav class="sg-docs-nav" aria-label="<?php esc_attr_e('Secure Guard documentation sections', 'wp-secure-guard'); ?>">
                        <ul>
                            <li><a href="#getting-started"><?php esc_html_e('Getting Started', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#security-assistant"><?php esc_html_e('Security Assistant', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#presets"><?php esc_html_e('Security Presets', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#jwt-authentication"><?php esc_html_e('JWT Authentication', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#rest-api-security"><?php esc_html_e('REST API Security', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#whitelists-compatibility"><?php esc_html_e('Whitelists & Compatibility', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#login-unban-recovery"><?php esc_html_e('Login & Unban Recovery', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#emergency-lockdown"><?php esc_html_e('Emergency Lockdown', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#adaptive-security"><?php esc_html_e('Adaptive Security', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#hardening"><?php esc_html_e('Hardening', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#logs-reports"><?php esc_html_e('Logs & Reports', 'wp-secure-guard'); ?></a></li>
                            <li><a href="#troubleshooting"><?php esc_html_e('Troubleshooting', 'wp-secure-guard'); ?></a></li>
                        </ul>
                    </nav>
                </aside>
                ...
                <main class="sg-docs-content">
                    <section id="getting-started" class="card">
                        <h2><?php esc_html_e('Getting Started', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="security-assistant" class="card">
                        <h2><?php esc_html_e('Security Assistant', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="presets" class="card">
                        <h2><?php esc_html_e('Security Presets', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="jwt-authentication" class="card">
                        <h2><?php esc_html_e('JWT Authentication', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="rest-api-security" class="card">
                        <h2><?php esc_html_e('REST API Security', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="whitelists-compatibility" class="card">
                        <h2><?php esc_html_e('Whitelists & Compatibility', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="login-unban-recovery" class="card">
                        <h2><?php esc_html_e('Login & Unban Recovery', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="emergency-lockdown" class="card">
                        <h2><?php esc_html_e('Emergency Lockdown', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="adaptive-security" class="card">
                        <h2><?php esc_html_e('Adaptive Security', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="hardening" class="card">
                        <h2><?php esc_html_e('Hardening', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="logs-reports" class="card">
                        <h2><?php esc_html_e('Logs & Reports', 'wp-secure-guard'); ?></h2>
                    ...
                    <section id="troubleshooting" class="card">
                        <h2><?php esc_html_e('Troubleshooting', 'wp-secure-guard'); ?></h2>
